...
Do not model pastors or regional administrators as broad platform admins. Pastor authority requires cedula-backed approval and stays limited to professional/company authorization inside the approved district/church scope. Regional administrator authority requires cedula plus appointment evidence and stays limited to the approved union or association scope. Pastor/regional authorization must never activate the final product license; only a super administrator or authorized union administrator may perform license activation.
