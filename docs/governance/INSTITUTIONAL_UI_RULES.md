...
8. Informational media mosaics may use slow floating motion and pointer-responsive parallax only when the movement stays subtle, calm, and secondary to the content. Visual media inside those mosaics must preserve their rounded framing, and the hover response may feel present but must still stay controlled and free of abrupt jumps or broken geometry. These sections must read as informative christocentric storytelling, not as generic editorial placeholders.
